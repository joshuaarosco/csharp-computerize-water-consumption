...
Public Class frm_create_account
    ...
    Private Sub btn_create_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_create.Click
        If (txt_fname.Text = "" Or txt_lname.Text = "" Or txt_contact_number.Text = "" Or txt_address.Text = "") Then
        ...
        Else
            ...
            Try
                MysqlConn.Open()
                Dim Query As String
                Query = "insert into computerized_water_consumption_db.user (fname,lname,contact_number,address,created_at) values ('" & txt_fname.Text & "', '" & txt_lname.Text & "', '" & txt_contact_number.Text & "', '" & txt_address.Text & "', '" & DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss") & "')"
                Command = New MySqlCommand(Query, MysqlConn)
                Reader = Command.ExecuteReader

                Dim result As Integer = MessageBox.Show("Account was successfully created", "  System Message", MessageBoxButtons.OK)
